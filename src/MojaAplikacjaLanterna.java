...
//final GUIScreen guiScreen = TerminalFacade.createGUIScreen();
        Terminal terminal = TerminalFacade.createTerminal(StandardCharsets.UTF_8);
...
//false, false, false);
    ...
    public static void test4(){
        final GUIScreen guiScreen = TerminalFacade.createGUIScreen();
        final Window menuWindow = new Window("Menu");
        menuWindow.setWindowSizeOverride(new TerminalSize(80,80));
        menuWindow.setSoloWindow(true);
        Button button = new Button("Enter");
        menuWindow.addComponent(button,LinearLayout.GROWS_VERTICALLY);
        //TextGraphics kolor
        //setBackgroundColor(Terminal.Color.RED);
        //button.repaint();

        guiScreen.getScreen().startScreen();
        guiScreen.showWindow(menuWindow);
    ...
    public static void test3() {
        ...
        //button.repaint();
        //button.repaint(Terminal.Color.RED);
        button.setAlignment(Component.Alignment.BOTTON_CENTER);
        panel.addComponent(button, LinearLayout.GROWS_HORIZONTALLY);

        Table table = new Table(6,"cokolwiek");
